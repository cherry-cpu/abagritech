...
$data = array(
    'merchant_id' => HDFC_MERCHANT_ID,
    'order_id' => 'ORD_' . uniqid() . '_' . time(), // Unique Order ID
    'amount' => $_POST['amount'],
    'currency' => 'INR',
    'redirect_url' => HDFC_REDIRECT_URL,
    'cancel_url' => HDFC_CANCEL_URL,
    'language' => 'EN',
...
<body>
    <center>
        ...
        <form method="post" name="redirect" action="<?php echo HDFC_TRANSACTION_URL; ?>"> 
            <?php
